*! Ver 1.00  13.12.2021. first release
*
* Stata implementation of Cohen-Sutherland line clipping algorithm
...
void getmanbounds(points,xlo,xhi,ylo,yhi,xmin,xmax,ymin,ymax,real scalar value)
{
	...
	displacex = (xhi - xlo) * value
	displacey = (yhi - ylo) * value
...
void getautobounds(points,xmin,xmax,ymin,ymax,real scalar value)
{
	...
	displacex = (max(mymat[.,1]) - min(mymat[.,1])) * value
	displacey = (max(mymat[.,2]) - min(mymat[.,2])) * value
